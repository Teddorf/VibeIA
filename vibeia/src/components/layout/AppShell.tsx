...
const defaultNavItems: NavItem[] = [
  ...
  { name: 'New Project', href: '/new-project', icon: 'plus', section: 'Main' },
  { name: 'Teams', href: '/teams', icon: 'users', section: 'Collaborate' },
  { name: 'Orchestrator', href: '/orchestrator', icon: 'cpu', section: 'Collaborate' },
  { name: 'Settings', href: '/settings', icon: 'settings', section: 'Account' },
  { name: 'Profile', href: '/profile', icon: 'user', section: 'Account' },
];
        ...
        {isMobile && isMobileMenuOpen && (
          <div className="fixed inset-0 z-40 flex">
            ...
            <div className="relative z-50">
              <Sidebar items={defaultNavItems} collapsed={false} showUser={true} />
            </div>
          </div>
        )}
