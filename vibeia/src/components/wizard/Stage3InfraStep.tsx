  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle className="text-3xl">Infraestructura</CardTitle>
        <CardDescription>
          Selecciona tu base de datos y plataforma de deploy, o deja que detectemos automáticamente la mejor opción.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-8">
        ...
        <section>
          <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
            <span className="w-8 h-8 bg-purple-500/10 text-purple-500 rounded-full flex items-center justify-center text-sm font-bold">1</span>
            Base de Datos
          </h3>
          <div
        ...
        <section>
          <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
            <span className="w-8 h-8 bg-cyan-500/10 text-cyan-500 rounded-full flex items-center justify-center text-sm font-bold">2</span>
        ...
        <section>
          <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
            <span className="w-8 h-8 bg-yellow-500/10 text-yellow-500 rounded-full flex items-center justify-center text-sm font-bold">3</span>
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-lg p-6">
              <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div className="text-center">
                  ...
                  <p data-testid="monthly-cost" className="text-2xl font-bold text-slate-900 dark:text-white">
              ...
              <tbody>
                {[...databaseProviders, ...deployProviders].map((provider) => (
                  <tr key={provider.id} className="border-b border-slate-100 dark:border-slate-800">
                    ...
                    <td className="py-2 px-3">{provider.pricing.pro || provider.pricing.starter}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="bg-slate-50 dark:bg-slate-800/50 rounded-lg p-4 text-center">
          <p className="text-sm text-slate-500 mb-3">
            ¿No estás seguro? Podemos detectar automáticamente la mejor opción basada en tu proyecto.
          </p>
