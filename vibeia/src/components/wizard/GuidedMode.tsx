...
const PROJECT_TYPES: ProjectType[] = [
  {
    ...
    aiMessage:
      'Los proyectos SaaS típicamente necesitan autenticación de usuarios, sistema de pagos y un dashboard administrativo.',
  },
  {
    id: 'ecommerce',
    name: 'E-commerce',
    ...
    aiMessage:
      'Para E-commerce recomiendo incluir carrito de compras, pagos seguros y gestión de inventario.',
  },
  {
    id: 'api',
    name: 'API',
  ...
  },
  {
    ...
    aiMessage:
      'Las landings efectivas incluyen formularios de captura, analytics y optimización SEO.',
  },
  {
    id: 'mobile',
    name: 'Mobile',
  ...
  const renderStep1 = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Selecciona el tipo que mejor describe tu proyecto</p>
      </div>
        ...
        {PROJECT_TYPES.map((type) => (
          <div
            ...
            className={cn(
              ...
              selectedType === type.id ? 'border-primary bg-primary/5 selected' : 'border-border',
            )}
          >
            <div className="flex items-start justify-between">
              <div className="p-2 rounded-lg bg-slate-100 dark:bg-slate-800">{type.icon}</div>
              <button
      ...
      default:
        return (
          <div className="text-center py-12">
            <p className="text-muted-foreground">Paso {step} - En construcción</p>
          </div>
        );
    }
  };
  ...
  return (
    <div className="space-y-6">
        ...
        >
          ...
          {selectedType && currentType && (
            <div className="mt-4 pt-4 border-t border-primary/20">
              <p className="text-xs text-muted-foreground mb-2">Features sugeridas:</p>
              <div className="flex flex-wrap gap-1">
                {currentType.suggestedFeatures.map((f) => (
                  <span key={f} className="text-xs px-2 py-1 bg-primary/10 rounded-full">
                    {f}
                  </span>
                ))}
              </div>
      ...
      <div className="flex justify-between pt-4 border-t">
        <Button variant="outline" onClick={handleBack} disabled={step === 1 && !onBack}>
