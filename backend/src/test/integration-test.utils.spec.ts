...
describe('Integration Test Utilities', () => {
  describe('Database Setup', () => {
    ...
    it(
      'should setup an in-memory database',
      async () => {
    ...
    it(
      'should allow creating and querying documents',
      async () => {
  ...
  describe('clearDatabase', () => {
    ...
    it(
      'should clear all documents from all collections',
      async () => {
  ...
  describe('createTestTimestamps', () => {
    it('should return createdAt and updatedAt dates', () => {
      ...
      expect(timestamps.createdAt.getTime()).toBe(
        timestamps.updatedAt.getTime(),
      );
    });
  });
